...
usage: bgp-ipv4-cfg-PE2-ydk.py [-h] [-v] device
...
def config_bgp(bgp):
    ...
    four_byte_as.default_vrf.global_.router_id = "110.1.1.1"                    
    ...
    vrf.vrf_global.route_distinguisher.as_ = 11
    vrf.vrf_global.route_distinguisher.as_index = 11
    ...
    vrf_neighbor.neighbor_address = "110.1.1.2"
    vrf_neighbor.remote_as.as_xx = 0
    vrf_neighbor.remote_as.as_yy = 300
    ...
    vrf.vrf_global.route_distinguisher.type = xr_ipv4_bgp_cfg.BgpRouteDistinguisherEnum.four_byte_as
    vrf.vrf_global.route_distinguisher.as_xx = 0
    vrf.vrf_global.route_distinguisher.as_ = 12
    vrf.vrf_global.route_distinguisher.as_index = 12
    vrf.vrf_global.exists = Empty()
    # vrf global af
    vrf_global_af = vrf.vrf_global.vrf_global_afs.VrfGlobalAf()
    vrf_global_af.af_name = xr_ipv4_bgp_datatypes.BgpAddressFamilyEnum.ipv4_unicast
    ...
    # vrf neighbor
    vrf_neighbor = vrf.vrf_neighbors.VrfNeighbor()
    vrf_neighbor.neighbor_address = "120.1.1.2"
    vrf_neighbor.neighbor_group_add_member = "ce"
    # vrf neighbor af
    vrf.vrf_neighbors.vrf_neighbor.append(vrf_neighbor)
    four_byte_as.vrfs.vrf.append(vrf)
    ...
    vrf.vrf_global.route_distinguisher.type = xr_ipv4_bgp_cfg.BgpRouteDistinguisherEnum.four_byte_as
    vrf.vrf_global.route_distinguisher.as_xx = 0
    vrf.vrf_global.route_distinguisher.as_ = 13
    vrf.vrf_global.route_distinguisher.as_index = 13
    vrf.vrf_global.exists = Empty()
    # vrf global af
    vrf_global_af = vrf.vrf_global.vrf_global_afs.VrfGlobalAf()
    vrf_global_af.af_name = xr_ipv4_bgp_datatypes.BgpAddressFamilyEnum.ipv4_unicast
    ...
    # vrf neighbor
    vrf_neighbor = vrf.vrf_neighbors.VrfNeighbor()
    vrf_neighbor.neighbor_address = "130.1.1.2"
    vrf_neighbor.neighbor_group_add_member = "ce"
    # vrf neighbor af
    vrf.vrf_neighbors.vrf_neighbor.append(vrf_neighbor)
    four_byte_as.vrfs.vrf.append(vrf)
    ...
    vrf.vrf_global.route_distinguisher.type = xr_ipv4_bgp_cfg.BgpRouteDistinguisherEnum.four_byte_as
    vrf.vrf_global.route_distinguisher.as_xx = 0
    vrf.vrf_global.route_distinguisher.as_ = 14
    vrf.vrf_global.route_distinguisher.as_index = 14
    vrf.vrf_global.exists = Empty()
    # vrf global af
    vrf_global_af = vrf.vrf_global.vrf_global_afs.VrfGlobalAf()
    vrf_global_af.af_name = xr_ipv4_bgp_datatypes.BgpAddressFamilyEnum.ipv4_unicast
    ...
    # vrf neighbor
    vrf_neighbor = vrf.vrf_neighbors.VrfNeighbor()
    vrf_neighbor.neighbor_address = "140.1.1.2"
    vrf_neighbor.neighbor_group_add_member = "ce"
    # vrf neighbor af
    vrf.vrf_neighbors.vrf_neighbor.append(vrf_neighbor)
    four_byte_as.vrfs.vrf.append(vrf)
