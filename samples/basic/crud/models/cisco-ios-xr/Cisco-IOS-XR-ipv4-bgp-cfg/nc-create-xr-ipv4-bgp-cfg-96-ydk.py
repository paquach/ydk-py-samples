...
usage: bgp-ipv4-cfg-CE2-ydk.py [-h] [-v] device
...
def config_bgp(bgp):
    ...
    four_byte_as.default_vrf.global_.router_id = "110.1.1.2"                         
    ...
    # configure neighbor 110.1.1.1
    neighbor = four_byte_as.default_vrf.bgp_entity.neighbors.Neighbor()
    neighbor.neighbor_address = "110.1.1.1"
