...
usage: nc-create-xr-ipv4-ospf-cfg-41-ydk.py [-h] [-v] device name areaID interface
...
def config_ospf(ospf, name, areaid, interface):
...
if __name__ == "__main__":
    ...
    config_ospf(ospf, args.name, args.areaid, args.interface)  # add object configuration
